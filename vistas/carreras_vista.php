<?php include 'header.php'; ?>
                ...
                <div class="p-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Carreras</h1>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" class="user">
                        ...
                        <div class="form-group">   
                            <input class="form-control form-control-user" type="text" placeholder="Clave">
                        </div>
                        <div class="form-group">
                            <input class="form-control form-control-user" type="text" placeholder="Area">
                        </div>
                        <div class="form-group">
                            <input class="form-control form-control-user" type="number" placeholder="Creditos">
                        </div>
